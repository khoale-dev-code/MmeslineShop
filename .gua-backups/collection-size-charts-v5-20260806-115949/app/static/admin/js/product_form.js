    ...
    init() {
      ...
      if (deleteButton && deleteForm && deleteButton.dataset.deleteBound !== "1") {
        ...
        deleteButton.addEventListener("click", () => {
          ...
          const productName = cleanText(form?.dataset.productName) || "sản phẩm này";
          const message = FormState.dirty
            ? `Bạn đang có thay đổi chưa lưu. Xóa “${productName}” sẽ bỏ các thay đổi đó và chuyển sản phẩm vào thùng rác. Tiếp tục?`
            : `Chuyển “${productName}” vào thùng rác? Tồn kho đã được xác nhận bằng 0.`;
